...
export function HotspotPinPickerInput(props: any) {
    ...
    client
      ...
      .then((url) => {
        if (url) {
          ...
          // Imagen predeterminada si no se ha subido una en Sanity
  ...
  return (
    <Card padding={2} radius={2} shadow={1} border style={{ backgroundColor: '#ffffff', maxWidth: '700px' }}>
      <Box padding={2}>
      ...
      >
        ...
        {bgUrl && (
          <img
            ...
            style={{ width: '100%', height: 'auto', display: 'block', pointerEvents: 'none', opacity: 0.85 }}
          />
        )}
